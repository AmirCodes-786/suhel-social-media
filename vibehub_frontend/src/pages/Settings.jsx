          ...
          <div className="md:col-span-3">
            <div className="bg-white border border-slate-100 rounded-3xl p-6 md:p-8 shadow-sm">
              ...
              {activeTab === 'profile' && (
                <form onSubmit={handleSaveProfile} className="space-y-6">
                  <div>
                    ...
                    <p className="text-xs text-slate-500 mt-0.5">This information will be displayed publicly on your VibeHub profile.</p>
                  </div>

                  {/* Feedback Banners */}
                  {errorMessage && (
                    <div className="p-4 rounded-2xl bg-rose-50 border border-rose-100 flex gap-3 items-center text-xs text-rose-600">
                  ...
                  {saveSuccess && (
                    <div className="p-4 rounded-2xl bg-emerald-50 border border-emerald-100 flex gap-3 items-center text-xs text-emerald-700">
                  ...
                  <div className="space-y-4">
                    <label className="block text-xs font-bold text-slate-700 uppercase tracking-wider">Profile Images</label>
                    
                    {/* Cover Photo Area */}
                    <div className="relative h-32 md:h-40 rounded-2xl bg-slate-100 overflow-hidden border border-slate-200 group">
                      {coverPreview ? (
                        <img src={coverPreview} alt="Cover" className="w-full h-full object-cover" />
                      ) : (
                        <div className="w-full h-full bg-gradient-to-r from-indigo-500/10 via-purple-500/10 to-pink-500/10 flex items-center justify-center text-slate-400 text-xs">
                          No cover photo
                        </div>
                      )}
                      <button
                        ...
                        className="absolute top-3 right-3 bg-black/60 hover:bg-black/80 text-white text-xs px-3 py-1.5 rounded-xl backdrop-blur-md flex items-center gap-1.5 transition-all cursor-pointer"
                      >
                    ...
                    <div className="flex items-center gap-5 pt-2">
                      <div className="relative group">
                        <div className="h-20 w-20 rounded-full bg-slate-100 ring-4 ring-white shadow-md overflow-hidden flex items-center justify-center">
                          {avatarPreview ? (
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-500 mt-0.5">JPG, PNG or GIF. Recommended 400x400px.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        placeholder="John"
                        className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-xs text-slate-900 focus:bg-white focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all"
                      />
                    </div>
                    <div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full bg-slate-50 border border-slate-200 rounded-xl p-4 text-xs text-slate-900 focus:bg-white focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all resize-none"
                    />
                  </div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full bg-slate-50 border border-slate-200 rounded-xl pl-10 pr-4 py-2.5 text-xs text-slate-900 focus:bg-white focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all"
                        />
                      </div>
                    </div>
                    <div>
                ...
                <div className="space-y-6 text-left">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          value={user?.email || ''}
                          disabled
                          className="w-full bg-slate-100 border border-slate-200 rounded-xl pl-10 pr-4 py-2.5 text-xs text-slate-600"
                        />
                      </div>
                    </div>

                    <div>
                      <label className="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-2">User ID</label>
                      <input
                        type="text"
                  ...
                  <div className="pt-6 border-t border-slate-100 space-y-4">
                    ...
                    <div className="flex items-center justify-between p-4 rounded-2xl bg-slate-50 border border-slate-100">
                      <div>
                        ...
                        <span className="text-[11px] text-slate-500">Only approved followers can view your vibe and posts.</span>
                      </div>
                      <input
                        type="checkbox"
                  ...
                  <div className="pt-4 border-t border-slate-100">
                    <button
                      ...
                      className="text-xs font-bold text-rose-600 hover:text-rose-700 bg-rose-50 hover:bg-rose-100 px-4 py-2.5 rounded-xl flex items-center gap-2 transition-all cursor-pointer"
                    >
              ...
              {activeTab === 'notifications' && (
                <div className="space-y-6 text-left">
                  <div>
                    ...
                    <p className="text-xs text-slate-500 mt-0.5">Control how and when you want to receive alerts from VibeHub.</p>
                  </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between p-4 rounded-2xl bg-slate-50 border border-slate-100">
                      <div>
                        ...
                        <span className="text-[11px] text-slate-500">Receive alerts when someone likes, comments, or follows you.</span>
                      </div>
                      <input
                        type="checkbox"
                        checked={pushNotifs}
                    ...
                    <div className="flex items-center justify-between p-4 rounded-2xl bg-slate-50 border border-slate-100">
                      <div>
                        <span className="text-xs font-bold text-slate-800 block">Email Digest</span>
                        <span className="text-[11px] text-slate-500">Receive weekly summaries of trending posts and creator highlights.</span>
                      </div>
                      <input
                        type="checkbox"
                        checked={emailNotifs}
              ...
              {activeTab === 'appearance' && (
                <div className="space-y-6 text-left">
                  <div>
                    <h2 className="text-xl font-bold text-slate-900">Theme & Appearance</h2>
                    <p className="text-xs text-slate-500 mt-0.5">Customize your interface look and feel.</p>
                  </div>

                  <div className="flex items-center justify-between p-4 rounded-2xl bg-slate-50 border border-slate-100">
                    <div>
                      <span className="text-xs font-bold text-slate-800 block">Dark Mode</span>
                      <span className="text-[11px] text-slate-500">Toggle dark palette for lower eye strain at night.</span>
                    </div>
                    <input
                      type="checkbox"
                      checked={darkMode}
