...
export const PostCardSkeleton = () => (
  <div className="bg-white border border-slate-100 rounded-2xl p-4 mb-6 shadow-xs animate-pulse font-outfit">
    {/* Author Header */}
...
export const StoriesSkeleton = () => (
  <div className="flex gap-4 p-4 bg-white border border-slate-100 rounded-2xl shadow-xs mb-6 overflow-hidden animate-pulse">
    {[...Array(6)].map((_, i) => (
