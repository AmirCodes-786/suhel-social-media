...
export const PostCardSkeleton = () => (
  <div className="bg-white border border-slate-100 rounded-2xl p-4 mb-6 shadow-xs shimmer-loader font-outfit">
    {/* Author Header */}
    ...
    {/* Media placeholder */}
    <div className="w-full h-64 bg-slate-100 rounded-xl mb-3" />
...
export const StoriesSkeleton = () => (
  <div className="flex gap-4 p-4 bg-white border border-slate-100 rounded-2xl shadow-xs mb-6 overflow-hidden shimmer-loader">
    {[...Array(6)].map((_, i) => (
